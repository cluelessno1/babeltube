...
| 13 | English audio, **no captions** (e.g. `wYYYsWAhzwk`) | No banner; popup **Couldn't detect video language** + **No captions** (or **Already in target** if `getAudioTrack` resolves after wait) |
